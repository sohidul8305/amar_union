                ...
                <form id="family-form" onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div><label className="block text-sm font-semibold text-gray-700 mb-1">ইস্যুর তারিখ</label><input type="date" name="issueDate" value={headInfo.issueDate} onChange={handleHeadChange} className="w-full border border-gray-300 p-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#000F9F]" /></div>
                        </div>
                    </div>
