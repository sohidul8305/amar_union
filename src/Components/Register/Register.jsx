            ...
            <div className="max-w-2xl w-full space-y-6 bg-white p-6 sm:p-10 rounded-2xl shadow-xl border border-slate-100">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="flex flex-col items-center justify-center space-y-2">
                        ...
                        <div className="relative h-24 w-24 rounded-full border-2 border-dashed border-slate-300 flex items-center justify-center overflow-hidden bg-slate-50 hover:border-[#0b6330] transition duration-200">
                            {imagePreview ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="fullName" type="text" required value={formData.fullName} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="উদা: মোঃ আব্দুর রহমান" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">এনআইডি / জন্ম নিবন্ধন নম্বর</label>
                            <input name="nidOrBrd" type="number" required value={formData.nidOrBrd} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="NID বা Birth Certificate No." />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">মোবাইল নম্বর</label>
                            <input name="mobile" type="tel" required value={formData.mobile} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="01XXXXXXXXX" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">ইমেইল ঠিকানা</label>
                            <input name="email" type="email" required value={formData.email} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="example@email.com" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">পাসওয়ার্ড</label>
                            <input name="password" type="password" required value={formData.password} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="••••••••" autoComplete="new-password" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">পাসওয়ার্ড নিশ্চিত করুন</label>
                            <input name="confirmPassword" type="password" required value={formData.confirmPassword} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0b6330] focus:border-[#0b6330]" placeholder="••••••••" autoComplete="new-password" />
                        </div>
                    </div>
                ...
                <div className="text-center pt-3 border-t border-slate-100">
                    <p className="text-sm text-slate-600">
                        পূর্বেই অ্যাকাউন্ট করা আছে? <Link to="/login" className="font-bold text-[#0f4c81] hover:text-[#0b6330]">লগইন করুন</Link>
                    </p>
                </div>
            </div>
        </div>
