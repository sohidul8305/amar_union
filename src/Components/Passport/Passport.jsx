...
const Passport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.fatherName || !formData.village || 
        ...
        !formData.email || !formData.nidNumber) {
      Swal.fire({
        icon: 'warning',
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-6 md:p-12 shadow-2xl rounded-lg border-t-8 border-blue-600">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-8 uppercase">পাসপোর্ট সুপারিশপত্র ফরম</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-gray-700 space-y-4 border-t pt-8">
            ...
            <p className="text-lg">
              তিনি একজন পাসপোর্ট প্রত্যাশী। আমার জানামতে তার জাতীয় পরিচয়পত্র নম্বর <strong>{formData.nidNumber || '........'}</strong>। পাসপোর্ট প্রাপ্তির ক্ষেত্রে তার কোনো আইনগত বাধা নেই বলে আমি জানি।
            </p>
