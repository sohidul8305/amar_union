...
const Noc = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.fatherName || !formData.village || 
        ...
        !formData.nocPurpose || !formData.email) {
      Swal.fire({
        icon: 'warning',
      ...
      <div className="max-w-3xl mx-auto bg-white p-6 md:p-12 shadow-2xl rounded-lg border-t-8 border-blue-600">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <input type="text" name="nocPurpose" placeholder="অনাপত্তির বিষয় (কেন NOC প্রয়োজন)" value={formData.nocPurpose} onChange={handleChange} className="p-3 border rounded-lg w-full focus:ring-2 focus:ring-blue-600 outline-none md:col-span-2" required />
