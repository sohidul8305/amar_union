...
const Permission = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const required = ['name', 'fatherName', 'village', 'postOffice', 'upazila', 'district', 'nid', 'mobile', 'email', 'subject', 'issueDate'];
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-6 md:p-12 shadow-2xl rounded-lg border-t-8 border-blue-600">
        <h1 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-8 uppercase">অনুমতি পত্র ফরম</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-10">
            ...
            {/* অনুমতির বিষয় ও ইস্যুর তারিখ */}
            <input type="text" name="subject" placeholder="অনুমতির বিষয়" value={formData.subject} onChange={handleChange} className="p-3 border rounded-lg w-full focus:ring-2 focus:ring-blue-600 outline-none sm:col-span-2" required />
