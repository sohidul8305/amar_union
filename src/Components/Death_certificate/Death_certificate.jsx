...
const Death_certificate = () => {
    const [formData, setFormData] = useState({
        ...
        deathPlace: 'বাসস্থান',
        nidOrBrn: '',
        // মৃত ব্যক্তির ঠিকানা (নতুন ফিল্ড)
        village: '',
        postOffice: '',      // নতুন
        upazila: '',         // নতুন
        district: '',        // নতুন
    ...
    const handleSubmit = async (e) => {
        ...
        // বেসিক ভ্যালিডেশন
        const required = ['deceasedName', 'fatherName', 'motherName', 'gender', 'deathDate', 'deathReason', 'deathPlace', 'nidOrBrn',
            'village', 'postOffice', 'upazila', 'district', 'ward', 'postCode',
            'applicantName', 'applicantFatherName', 'applicantNid', 'applicantMobile', 'email', 'issueDate'];
                ...
                try {
                    ...
                    if (data.success) {
                        Swal.fire({
                            ...
                            html: `<strong>আবেদন আইডি: ${data.deathCertId}</strong>`,
                            confirmButtonColor: '#000F9F'
                        });
                        // ফর্ম রিসেট
                        setFormData({
        ...
        <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
                    ...
                    {/* ===== মৃত্যু সংক্রান্ত বিবরণ ও ঠিকানা (ডাকঘর, উপজেলা, জেলা সহ) ===== */}
                    <div className="space-y-4">
                        <h3 className="text-lg font-bold text-[#000F9F] flex items-center gap-2 border-b pb-2 border-gray-100">
                            <span>📅</span> মৃত্যু সংক্রান্ত বিবরণ ও মৃতের শেষ ঠিকানা
                        </h3>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-2">
                            ...
                            <div>
                                ...
                                <input required type="text" name="postOffice" value={formData.postOffice} onChange={handleChange} className="w-full border border-gray-300 p-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#000F9F]" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">উপজেলা <span className="text-red-500">*</span></label>
                                <input required type="text" name="upazila" value={formData.upazila} onChange={handleChange} className="w-full border border-gray-300 p-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#000F9F]" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">জেলা <span className="text-red-500">*</span></label>
                                <input required type="text" name="district" value={formData.district} onChange={handleChange} className="w-full border border-gray-300 p-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#000F9F]" />
                            </div>
                            <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">পিতার নাম <span className="text-red-500">*</span></label>
                                <input required type="text" name="applicantFatherName" value={formData.applicantFatherName} onChange={handleChange} className="w-full border border-gray-300 p-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#000F9F]" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">মৃতের সাথে সম্পর্ক <span className="text-red-500">*</span></label>
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">এনআইডি নম্বর <span className="text-red-500">*</span></label>
