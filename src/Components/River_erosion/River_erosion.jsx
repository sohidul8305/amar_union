...
const River_erosion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.fatherName || !formData.village || 
        ...
        !formData.landDetails || !formData.lossDetails || !formData.email) {
      Swal.fire({
        icon: 'warning',
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-6 md:p-12 shadow-2xl rounded-lg border-t-8 border-blue-600">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-8 uppercase">নদী ভাঙনের সনদপত্র ফরম</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <input type="text" name="landDetails" placeholder="জমির বিবরণ (দাগ/খতিয়ান)" value={formData.landDetails} onChange={handleChange} className="p-3 border rounded-lg w-full focus:ring-2 focus:ring-blue-600 outline-none md:col-span-2" required />
            <input type="text" name="lossDetails" placeholder="নদী ভাঙনের বিবরণ" value={formData.lossDetails} onChange={handleChange} className="p-3 border rounded-lg w-full focus:ring-2 focus:ring-blue-600 outline-none md:col-span-2" required />
          ...
          <div className="text-gray-700 space-y-4 border-t pt-8">
            ...
            <p className="text-sm text-gray-500">আবেদনকারীর ইমেইল: {formData.email || '........'}</p>
          </div>
